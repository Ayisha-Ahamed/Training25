...
// T2: Program to convert input number to words and roman numerals.
// ------------------------------------------------------------------------------------------------
...
internal class Program {
      ...
      do {
         ...
         if (int.TryParse (ReadLine (), out int output) && output >= 0) {
            ...
            switch (ReadKey (true).Key) {
               ...
               default: WriteLine ("Please press 'A' or 'B'!"); break;
            }
   ...
   public static string ConvertToRoman (int num) {
      ...
      Dictionary<int, string> numerals = new () { { 1000, "M" }, { 900, "CM" }, { 500, "D" },
