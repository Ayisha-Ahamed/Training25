   ...
   static void Main () {
      ...
      for (int i = 0; i < 17; i++)
         switch (i) {
            ...
            case 1: PrintChars (['♜', '♞', '♝', '♛', '♚', '♝', '♞', '♜']); break;
            case 3: PrintChars ([.. Enumerable.Repeat ('♟', 8)]); break;
            case 5 or 7 or 9 or 11: PrintChars ([.. Enumerable.Repeat (' ', 8)]); break;
            case 13: PrintChars ([.. Enumerable.Repeat ('♙', 8)]); break;
            case 15: PrintChars (['♖', '♘', '♗', '♕', '♔', '♗', '♘', '♖']); break;
            case 16: WriteLine ("\n┗━━━┻━━━┻━━━┻━━━┻━━━┻━━━┻━━━┻━━━┛"); break;
            default: WriteLine ("\n┣━━━╋━━━╋━━━╋━━━╋━━━╋━━━╋━━━╋━━━┫"); break;
         }
   }
